...
public class Test2 {
    public static void main(String[] args) throws IOException, InterruptedException {
        final ApnsClient apnsClient = new ApnsClientBuilder()
                .setClientCredentials(new File("/Users/hanxirui/Documents/workspace/github/for_java/javastone/src/main/resources/DevPush_05.05.p12"), "123456")
                .build();
        ...
        payloadBuilder.setAlertBody("来自德塔的智慧推送!");
