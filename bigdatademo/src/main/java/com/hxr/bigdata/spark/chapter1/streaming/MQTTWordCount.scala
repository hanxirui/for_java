 ...
 *    `$ bin/run-example \
 *      com.hxr.bigdata.spark.chapter1.streaming.MQTTPublisher tcp://localhost:1883 foo`
 * and run the example as
 *    `$ bin/run-example \
 *      com.hxr.bigdata.spark.chapter1.streaming.MQTTWordCount tcp://localhost:1883 foo`
 */
