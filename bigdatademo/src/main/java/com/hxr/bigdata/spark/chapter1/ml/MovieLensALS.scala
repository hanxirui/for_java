...
package com.hxr.bigdata.spark.chapter1.ml

import scopt.OptionParser

import org.apache.spark.{SparkConf, SparkContext}
import com.hxr.bigdata.spark.chapter1.mllib.AbstractParams
    ...
    val parser = new OptionParser[Params]("MovieLensALS") {
      ...
      note(
        """
          ...
          |
          | bin/spark-submit --class com.hxr.bigdata.spark.chapter1.ml.MovieLensALS \
