...
package com.hxr.bigdata.spark.chapter1.streaming.clickstream

import org.apache.spark.SparkContext._
import org.apache.spark.streaming.{Seconds, StreamingContext}
import com.hxr.bigdata.spark.chapter1.streaming.StreamingExamples
// scalastyle:off
/** Analyses a streaming dataset of web page views. This class demonstrates several types of
  ...
  * `$ bin/run-example com.hxr.bigdata.spark.chapter1.streaming.clickstream.PageViewGenerator 44444 10`
  * To process the generated stream
  * `$ bin/run-example \
  *    com.hxr.bigdata.spark.chapter1.streaming.clickstream.PageViewStream errorRatePerZipCode localhost 44444`
  */
// scalastyle:on
