...
*
*./bin/spark-submit --class com.hxr.bigdata.spark.chapter1.JavaSparkSQL --master local[1] bigdatademo.jar 
* <br>
*/
public class JavaSparkSQL {
  ...
  public static void main(final String[] args) throws Exception {
    SparkConf sparkConf = new SparkConf().setAppName("JavaSparkSQL131");
...
//  ---------------------------------------------------------------------------------------
    System.out.println("=== Data source: JSON Dataset NY Salaries ===");
    String salaryPath = "/spark/ny_salaries.json";
    DataFrame salaryFromJsonFile = sqlContext.jsonFile(salaryPath);
    salaryFromJsonFile.printSchema();
    ctx.stop();
  }
}
