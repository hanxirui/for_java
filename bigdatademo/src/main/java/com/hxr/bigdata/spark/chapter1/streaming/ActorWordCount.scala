 ...
 * data.
 *
 * @see [[com.hxr.bigdata.spark.chapter1.streaming.FeederActor]]
 */
 ...
 *    `$ bin/run-example com.hxr.bigdata.spark.chapter1.streaming.FeederActor 127.0.1.1 9999`
 * and then run the example
 *    `$ bin/run-example com.hxr.bigdata.spark.chapter1.streaming.ActorWordCount 127.0.1.1 9999`
 */
