 ...
 * {{{
 * bin/run-example com.hxr.bigdata.spark.chapter1.mllib.BinaryClassification
 * }}}
    ...
    val parser = new OptionParser[Params]("BinaryClassification") {
      ...
      note(
        """
          ...
          |
          | bin/spark-submit --class com.hxr.bigdata.spark.chapter1.mllib.BinaryClassification \
