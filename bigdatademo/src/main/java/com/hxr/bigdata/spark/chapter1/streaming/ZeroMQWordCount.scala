 ...
 *    `$ bin/run-example \
 *      com.hxr.bigdata.spark.chapter1.streaming.SimpleZeroMQPublisher tcp://127.0.1.1:1234 foo.bar`
 * and run the example as
 *    `$ bin/run-example \
 *      com.hxr.bigdata.spark.chapter1.streaming.ZeroMQWordCount tcp://127.0.1.1:1234 foo`
 */
// scalastyle:on
