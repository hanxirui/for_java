 ...
 * {{{
 * bin/run-example com.hxr.bigdata.spark.chapter1.mllib.MultivariateSummarizer
 * }}}
  ...
  def main(args: Array[String]) {
    ...
    val parser = new OptionParser[Params]("MultivariateSummarizer") {
      ...
      note(
        ...
        |
        | bin/spark-submit --class com.hxr.bigdata.spark.chapter1.mllib.MultivariateSummarizer \
