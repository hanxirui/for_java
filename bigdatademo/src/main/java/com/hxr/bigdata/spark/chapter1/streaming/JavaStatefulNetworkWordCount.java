...
/**
 * Counts words cumulatively in UTF8 encoded, '\n' delimited text received from the network every second starting with
 * initial value of word count. Usage: JavaStatefulNetworkWordCount <hostname> <port> <hostname> and <port> describe the
...
public class JavaStatefulNetworkWordCount {
    ...
    public static void main(final String[] args) {
        ...
        final Function2<List<Integer>, Optional<Integer>, Optional<Integer>> updateFunction = new Function2<List<Integer>, Optional<Integer>, Optional<Integer>>() {
            ...
            public Optional<Integer> call(final List<Integer> values, final Optional<Integer> state) {
