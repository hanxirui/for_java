...
public class ServerMQTTTemperature {
	...
	public static void main(String[] args) throws MqttException, InterruptedException {
		...
		int count = 0;
		String message = "{\"SerialNo\" : " + count + ",\"temperature\" : " + getRandom(10, 26) + ",   \"humidity\" : "
				+ getRandom(30, 66) + ", \"time\" : " + System.currentTimeMillis() + "}";
		while (true) {
			count++;
			server.message.setPayload(message.getBytes());
			message = "{\"SerialNo\" : " + count + ",\"temperature\" : " + getRandom(19, 21) + ",   \"humidity\" : "
					+ getRandom(40, 66) + ", \"time\" : " + System.currentTimeMillis() + "}";
