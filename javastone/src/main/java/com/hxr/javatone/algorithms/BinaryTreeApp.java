...
class BinaryTree {
    ...
    // ------------------------------------------------------------------------
    public TreeNode find(final int key) {
    ...
    // ------------------------------------------------------------------------
    public boolean delete(final int key) {// delete node with given key(assumes non-empty list)
        TreeNode current = root;
        ...
        while (current.iData != key) {// search for node
            ...
            if (current == null)
                return false; // end of the line,didn't find it
        ...
        // if no right child,replace with left subtree
            ...
            // connet parent of current to successor instead
            if (current == root)
                root = successor;
            else if (isLeftChild)
    ...
    private TreeNode getSuccessor(final TreeNode delNode) {
    ...
    // ------------------------------------------------------------------------
    private void preOrder(final TreeNode localRoot) {
        if (localRoot != null) {
    ...
    private void inOrder(final TreeNode localRoot) {
        if (localRoot != null) {
    ...
    private void postOrder(final TreeNode localRoot) {
        if (localRoot != null) {
