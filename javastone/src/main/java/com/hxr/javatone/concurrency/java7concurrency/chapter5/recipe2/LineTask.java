...
public class LineTask extends RecursiveTask<Integer>{
	 ...
	 */
	public LineTask(final String line[], final int start, final int end, final String word) {
		this.line=line;
		this.start=start;
		this.end=end;
		this.word=word;
	 ...
	 */
	private Integer count(final String[] line, final int start, final int end, final String word) {
		int counter;
		counter=0;
