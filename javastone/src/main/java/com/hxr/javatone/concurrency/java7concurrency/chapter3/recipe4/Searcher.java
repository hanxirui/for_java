package com.hxr.javatone.concurrency.java7concurrency.chapter3.recipe4;
...
public class Searcher implements Runnable {
	 ...
	 */
	public Searcher(final int firstRow, final int lastRow, final MatrixMock mock, final Results results, final int number, final CyclicBarrier barrier){
