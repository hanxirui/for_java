package com.hxr.javatone.concurrency.java7concurrency.chapter3.recipe5;
...
public class FileSearch implements Runnable {
	 ...
	 */
	public FileSearch(final String initPath, final String end, final Phaser phaser) {
	 ...
	 */
	private void directoryProcess(final File file) {
	 ...
	 *            : File to process
	 */
	private void fileProcess(final File file) {
