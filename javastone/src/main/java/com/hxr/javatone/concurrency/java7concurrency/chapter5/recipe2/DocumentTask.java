package com.hxr.javatone.concurrency.java7concurrency.chapter5.recipe2;
...
public class DocumentTask extends RecursiveTask<Integer> {
	 ...
	 */
	public DocumentTask (final String document[][], final int start, final int end, final String word){
	 ...
	 * @return
	 */
	private Integer processLines(final String[][] document, final int start, final int end,
			final String word) {
	 ...
	 */
	private Integer groupResults(final Integer number1, final Integer number2) {
		Integer result;
