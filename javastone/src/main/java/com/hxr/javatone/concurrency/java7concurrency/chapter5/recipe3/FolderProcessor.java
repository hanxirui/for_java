package com.hxr.javatone.concurrency.java7concurrency.chapter5.recipe3;
...
public class FolderProcessor extends RecursiveTask<List<String>> {
	 ...
	 */
	public FolderProcessor (final String path, final String extension) {
		this.path=path;
	 ...
	 */
	private void addResultsFromTasks(final List<String> list,
			final List<FolderProcessor> tasks) {
