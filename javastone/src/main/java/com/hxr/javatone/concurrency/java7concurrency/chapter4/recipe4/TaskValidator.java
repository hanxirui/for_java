package com.hxr.javatone.concurrency.java7concurrency.chapter4.recipe4;
...
public class TaskValidator implements Callable<String> {
	 ...
	 */
	public TaskValidator(final UserValidator validator, final String user, final String password){
