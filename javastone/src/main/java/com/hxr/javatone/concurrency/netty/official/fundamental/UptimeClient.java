...
public class UptimeClient {
    ...
    public UptimeClient(final String host, final int port) {
        this.host = host;
        this.port = port;
    }
    ...
    private Bootstrap configureBootstrap(final Bootstrap b) {
        return configureBootstrap(b, new NioEventLoopGroup());
    }

    Bootstrap configureBootstrap(final Bootstrap b, final EventLoopGroup g) {
        b.group(g)
