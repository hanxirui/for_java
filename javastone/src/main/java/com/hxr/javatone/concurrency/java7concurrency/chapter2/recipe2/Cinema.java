package com.hxr.javatone.concurrency.java7concurrency.chapter2.recipe2;
...
public class Cinema {
	 ...
	 */
	public boolean sellTickets1 (final int number) {
	 ...
	 * @return true if the tickets are sold, false if there is no vacancies
	 */
	public boolean sellTickets2 (final int number){
	 ...
	 * @return true
	 */
	public boolean returnTickets1 (final int number) {
		synchronized (controlCinema1) {
			vacanciesCinema1+=number;
			return true;
		}
	 ...
	 * @return true
	 */
	public boolean returnTickets2 (final int number) {
		synchronized (controlCinema2) {
			vacanciesCinema2+=number;
			return true;
		}
