      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="active"><a href="${ctx}customer.do"><i class="fa fa-circle-o"></i> 客户管理</a></li>
            <li ><a href="${ctx}employee.do"><i class="fa fa-circle-o"></i> 员工管理</a></li>
          </ul><!-- /.sidebar-menu -->
        </section>
        <!-- /.sidebar -->
      </aside>
