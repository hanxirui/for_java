    ...
    <jsp:param name="activeMenu" value="cse"/>
      ...
      <!--   <section class="content-header">
        ...
        <ul class="nav nav-pills">
		 ...
		 <li role="presentation" ><a href="${ctx}openFenpeilishi.do?id=${customer.id}">分配历史</a></li>
		  <li>
	                    ...
	                    <div class="form-group">
	                      ...
	                      <div class="col-sm-7">
								  <label class="radio-inline">
								    <input type="radio" name="type" id="type0" value="0">统一制式拜访
								  </label>
								  <label class="radio-inline">
								    <input type="radio" name="type" id="type1" value="1">自主拜访
								  </label>
	                      </div>
