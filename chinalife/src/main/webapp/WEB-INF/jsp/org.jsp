          ...
          <div class="box box-default">
               <div class="box-body">
                 ...
                 <form id="schFrm" class="form-inline" onsubmit="return false;">
										 										                       名称:<input name="name" type="text" class="form-control  input-sm">      
					 										                       机构号:<input name="code" type="text" class="form-control  input-sm">      
...
var listUrl = ctx + 'listOrg.do'; // 查询
var addUrl = ctx + 'addOrg.do'; // 添加
var updateUrl = ctx + 'updateOrg.do'; // 修改
var delUrl = ctx + 'delOrg.do'; // 删除
var submitUrl = ''; // 提交URL
