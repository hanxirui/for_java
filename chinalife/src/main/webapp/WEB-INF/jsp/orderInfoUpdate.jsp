    ...
    <div class="content">
        ...
        <div class="container-fluid">
            <div class="row-fluid">
				...
				<form id="ff" action="${ctx}jsp/updateOrderInfo.do" method="post">
			        <label>订单号</label>
			        <input type="text" name="orderId" value="${orderInfo.orderId}" readonly="readonly" class="input-xlarge">
			        <label>城市</label>
			        ...
			        <label>下单时间</label>
			        <input type="text" value="<fmt:formatDate value="${orderInfo.createDate}" pattern="yyyy-MM-dd HH:mm:ss"/>" readonly="readonly" class="input-xlarge">
