	...
	<section class="content">
		...
		<div class="box">
			<div class="box-header">
				...
				<div class="btn-group">
					<a href="${ctx}openCustomerForVisit.do?id=${customer.id}"
						class="btn btn-primary"><i class="fa fa-reply"></i>返回</a>
				</div>
			</div>
			<!-- /.box-header -->
		...
		<div id="crudWin">
			<form id="crudFrm" class="form-horizontal">
				...
				<div class="form-group">
					<label class="col-sm-3 control-label">拜访性质</label>
					<div class="col-sm-7">
						<label class="radio-inline"> <input type="radio"
							name="type" id="type0" value="0">统一制式拜访
		...
		<script type="text/javascript">
			...
			var listUrl = ctx
					+ 'listSitRecord.do?idcardnum=${customer.idcardnum}'; // 查询
