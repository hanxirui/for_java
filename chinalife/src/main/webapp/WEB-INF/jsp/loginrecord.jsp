...
<jsp:include page="../menu.jsp">
	<jsp:param name="activeMenu" value="login" />
</jsp:include>
...
<div class="content-wrapper">
	...
	<section class="content">
		...
		<div class="box box-default">
			<div class="box-body">
				...
				<form id="schFrm" class="form-inline" onsubmit="return false;">
					账号:<input name="empcode" type="text" class="form-control  input-sm">
					IP地址:<input name="ip" type="text" class="form-control  input-sm">
					登录时间:<input name="date" type="text" class="form-control  input-sm">
		...
		<div id="crudWin">
			<form id="crudFrm" class="form-horizontal">
				...
				<div class="form-group">
					...
					<div class="col-sm-7">
						<input name="date" type="text" class="form-control  input-sm"
							required="true">
					</div>
				</div>
			</form>
		...
		<script type="text/javascript">
			...
			var listUrl = ctx + 'listLoginrecord.do'; // 查询
			var addUrl = ctx + 'addLoginrecord.do'; // 添加
			var updateUrl = ctx + 'updateLoginrecord.do'; // 修改
			var delUrl = ctx + 'delLoginrecord.do'; // 删除
			var submitUrl = ''; // 提交URL
