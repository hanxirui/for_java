...
<!-- AdminLTE Skins. We have chosen the skin-blue for this starter
    ...
    -->
<link rel="stylesheet"
	href="${AdminLTE}dist/css/skins/skin-blue-light.min.css">
<link href="${res}css/jquery.gridster.min.css" rel="stylesheet"
	type="text/css" />
...
<!-- validate -->
<script src="${res}jqueryValidate/jquery.validate.min.js"
	type="text/javascript"></script>
<script src="${res}jqueryValidate/localization/messages_zh.min.js"
	type="text/javascript"></script>
<!-- dialog -->
