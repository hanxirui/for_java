...
/**
 * 
 * XML Utility Class <br>
 * 
 * <p>
 * Create on : 2011-7-26<br>
 * <p>
 * </p>
 * <br>
 * 
 * @author Sun ShouTian<br>
 * @version mscore-api v6.0.0
 *          <p>
 *          <br>
...
public class XmlUtils {
	 ...
	 */
	public static List<Node> getElementByXPath(String xpathStr, Document document) {
	 ...
	 * @return Element
	 */
	public static Element getFirstElementByTagName(String tagName, Document document) {
		...
		if (t_elements != null && t_elements.size() > 0) {
			for (int i = 0; i < t_elements.size(); i++) {
				...
				if (element != null && tagName.equalsIgnoreCase(element.getName())) {
					return element;
				}
			}
		}
	 ...
	 * @return Element
	 */
	public static Element getFirstChildElement(Element pareElement, String tagName) {
	 ...
	 * @return List<Element>
	 */
	public static List getChildElementsByTagName(Element pareElement, String tagName) {
		if (pareElement == null || tagName == null) {
			return null;
		}
	...
	public static boolean writeXML(String file, Document m_doc) {
		...
		try {
			...
			output = new org.dom4j.io.XMLWriter(new OutputStreamWriter(new FileOutputStream(file), "UTF8"), format);
			output.write(m_doc);
