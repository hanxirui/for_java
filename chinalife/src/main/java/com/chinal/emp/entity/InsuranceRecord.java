...
public class InsuranceRecord {
	...
	public void setYewuyuanName(String account) {
		this.yewuyuanName = account;
	}
	...
	public void setYewuyuanCode(String accountCode) {
		this.yewuyuanCode = accountCode;
	}

	public String getYewuyuanCode() {
		return this.yewuyuanCode;
	}
