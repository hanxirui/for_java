...
public class GongzidanSch extends BsgridSearch {
    ...
    private String zhijijintie;
    private String xiaoshoujingyingjintie;
    private String xinrenbaohu;
    private String nianzijintie;
    private String guanlijintie;
    private String duanxianyongjin;
    private String qudaoyongjin;
    private String ziyingyongjin;
    private String ziyingxuqi;
    private String wangdianxuqi;
    private String jiefa;
    private String xiaoji;
    private String qitakoukuan;
    private String koukuanxiaoji;
    private String yingfaxiaoji;
    private String fengognsijiangli;
    private String jicengjiangli;
    private String qitabutie;
    private String jicengqitabutie;
    private String zhanyejintie;
    private String fengongsishiwujiangli;
    private String jicengshiwujiangli;
    private String baoxianbaozhang;
    private String yingfaheji;
    private String weituoshebao;
    private String chanshuohuikoukuan;
    private String sandaikoukuanhechaoqikoukuan;
    private String gerensuodeshui;
    private String zengzhishui;
    private String chengjianshui;
    private String jiaoyufeifujia;
    private String difangjiaoyufeifujia;
    private String fanghongfei;
    private String koufengongsishiwujiangli;
    private String koujicenggongsishiwujiangli;
    private String koubaoxianbaozhang;
    private String shouxianshifajine;
    private String caixianjixiao;
    ...
    @ValueField(column = "yinhangzhanghao")
    ...
    @ValueField(column = "shenfenzhenghao")
    ...
    @ValueField(column = "xiaoshoujingyingjintie")
    ...
    @ValueField(column = "nianzijintie")
    ...
    @ValueField(column = "guanlijintie")
    ...
    @ValueField(column = "duanxianyongjin")
    ...
    @ValueField(column = "qudaoyongjin")
    ...
    @ValueField(column = "ziyingyongjin")
    ...
    @ValueField(column = "wangdianxuqi")
    ...
    @ValueField(column = "koukuanxiaoji")
    ...
    @ValueField(column = "yingfaxiaoji")
    ...
    @ValueField(column = "fengognsijiangli")
    ...
    @ValueField(column = "jicengjiangli")
    ...
    @ValueField(column = "jicengqitabutie")
    ...
    @ValueField(column = "zhanyejintie")
    ...
    @ValueField(column = "fengongsishiwujiangli")
    ...
    @ValueField(column = "jicengshiwujiangli")
    ...
    @ValueField(column = "baoxianbaozhang")
    ...
    @ValueField(column = "weituoshebao")
    ...
    @ValueField(column = "chanshuohuikoukuan")
    ...
    @ValueField(column = "sandaikoukuanhechaoqikoukuan")
    ...
    @ValueField(column = "gerensuodeshui")
    ...
    @ValueField(column = "chengjianshui")
    ...
    @ValueField(column = "jiaoyufeifujia")
    ...
    @ValueField(column = "difangjiaoyufeifujia")
    ...
    @ValueField(column = "koufengongsishiwujiangli")
    ...
    @ValueField(column = "koujicenggongsishiwujiangli")
    ...
    @ValueField(column = "koubaoxianbaozhang")
    ...
    @ValueField(column = "shouxianshifajine")
    ...
    @ValueField(column = "caixianjixiao")
    ...
    @ValueField(column = "koucaixianjixiao")
