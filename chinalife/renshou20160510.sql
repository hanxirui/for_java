...
-- ----------------------------
BEGIN;
INSERT INTO `customer_basic` VALUES ('1', '全冠清', '120123456789', '2', '2016-05-08', '2016-04-26', '11200000', '1', '2', '1', null, '天朝', null), ('2', '乔丹', '123', '1', '2016-05-04', '2016-05-04', '11200000', '1', null, '打篮球', null, '天津市', null), ('3', '钟灵', '132', '1', '2015-04-01', '2016-05-04', '11200000', '0', null, '玩', null, '万仇谷', null), ('4', '木婉清', '132', '1', '2016-05-26', '2016-05-25', '11200000', '0', null, '打篮球', null, '的', null), ('5', '穆念慈', '12', '1', '2011-05-05', '2016-05-04', '11200000', '0', null, '是', null, '12', null), ('6', '123', '123', '2', '2016-05-09', '2016-05-09', '11200000', '1', '3', '123', null, '123', null), ('7', 'qwe', 'qwe', '1', '2016-05-10', '2016-05-10', '11200000', '1', null, 'qwe', null, 'qwe', null);
COMMIT;
...
CREATE TABLE `insurance_record` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `org_code` varchar(30) DEFAULT NULL COMMENT '机构',
  `insurance_num` varchar(30) DEFAULT NULL COMMENT '保险单号',
  `tou_insurance_num` varchar(30) DEFAULT NULL COMMENT '投保单号',
  `type_code` varchar(30) DEFAULT NULL COMMENT '险种代码',
  `qudao` varchar(30) DEFAULT NULL COMMENT '渠道',
  `insurance_fei` varchar(30) DEFAULT NULL COMMENT '保费',
  `total_insurance_fei` varchar(30) DEFAULT NULL COMMENT '满期金额',
  `manqi_date` varchar(30) DEFAULT NULL COMMENT '满期日期',
  `fei_type` varchar(30) DEFAULT NULL COMMENT '缴费方式',
  `fei_qijian` varchar(30) DEFAULT NULL COMMENT '缴费期间',
  `insurance_qijian` varchar(30) DEFAULT NULL COMMENT '保险期间',
  `state` varchar(30) DEFAULT NULL COMMENT '保单状态',
  `customer_idcardnum` varchar(30) DEFAULT NULL COMMENT '投保人',
  `customer_addr` varchar(30) DEFAULT NULL COMMENT '地址',
  `customer_phone` varchar(30) DEFAULT NULL COMMENT '电话',
  `customer_mobile` varchar(30) DEFAULT NULL COMMENT '手机',
  `yewuyuan_name` varchar(30) DEFAULT NULL COMMENT '业务员姓名',
  `yewuyuan_code` varchar(30) DEFAULT NULL COMMENT '工号',
  `bank_name` varchar(30) DEFAULT NULL COMMENT '银行',
  `bank_card_num` varchar(30) DEFAULT NULL COMMENT '银行账号',
  `beibaoxianren` varchar(30) DEFAULT NULL COMMENT '被保险人',
  `shouyiren` varchar(30) DEFAULT NULL COMMENT '受益人',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
