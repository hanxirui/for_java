...
import com.springboot.zero.util.DESCoder;
...
/**
 * Shiro 配置 Apache Shiro 核心通过 Filter 来实现，就好像SpringMvc 通过DispachServlet 来主控制一样。 既然是使用 Filter
...
public class ShiroConfiguration {
    ...
    /**
     * shiro缓存管理器; 需要注入对应的其它的实体类中： 1、安全管理器：securityManager 可见securityManager是整个shiro的核心；
     *
     * @return
     */
    @Bean
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            String password = "123456";
                ...
                BigInteger number = new BigInteger(1, md.digest(md.digest()));
