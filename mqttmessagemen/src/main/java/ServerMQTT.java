...
//				+ 1411384196 + ",  \"PassResult\" : 1}]}";
        ...
        while (true) {
            count++;
            message = "{\"SerialNo\" : " + count + ",\"DeviceAddr\" : \"fjJct3xrb0Up\",   \"PassRecords\" :[ ";
            for (int i = 30; i < 51; i++) {
                identityCode = "757d6d" + i;
                result = count % 100 == 0 ? -1 : 1;

                message += "{ \"IdentityType\" : " + getRandom(101, 102) + ", \"IdentityCode\" : \"" + identityCode + "\", \"OriginalCode\" : \"" + identityCode + "\", \"PassTime\" : " + System.currentTimeMillis() + ",  \"PassResult\" : " + result + "}";
                if (i != 50) {
                    message += ",";
                }
            }
            ...
            Thread.sleep(getRandom(30000, 200000));
        }
